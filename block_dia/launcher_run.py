...
with SdkLauncher(artifact_path, simulator=False,  disable_version_check=True) as launcher:
    ...
    launcher.stage("A_diag_offset.csv")
    launcher.stage("A_row_start.csv")
    launcher.stage("A_len.csv")
    launcher.stage("A_diag_ptr.csv")
    launcher.stage("A_vals.csv")
    launcher.stage("num_diags.csv")
    launcher.stage("vals_len.csv")
    launcher.stage("has_work.csv")
